...
// Issue Unit I/O specialized for ISAX 
class IssueUnitISAXIO(
  val issueWidth: Int,
...
// Issue Unit specialized for ISAX 
class IssueUnitISAX(
  ...
  with IssueUnitConstants
{
  ...
  val io = IO(new IssueUnitISAXIO(issueWidth, numWakeupPorts, dispatchWidth))
